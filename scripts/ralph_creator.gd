...
const PROFILES := {
	...
	"raptor": {
		...
		"rarity": "RARE",
		"bio": "Quick as a sneeze and twice as messy. Jessie the raptor strikes before you've finished the thought of dodging.",
		"personality": "SWIFT • CLEVER • MISCHIEVOUS",
		"move_name": "DASH CLAW",
		"move_desc": "Jessie rockets forward with sickle claws raised. A clean hit renews the hunt — the cooldown almost fully refunds.",
		"move_type": "PHYSICAL",
