...
PART_DEFS_BY_DINO = {
    ...
    "pterry": {
        "back_leg":  {"box": (0.00, 0.30, 0.34, 0.88), "pivot": (0.32, 0.46)},  # far wing
        "front_leg": {"box": (0.66, 0.30, 1.00, 0.88), "pivot": (0.68, 0.46)},  # near wing
        "tail":      {"box": (0.36, 0.76, 0.64, 1.00), "pivot": (0.50, 0.80)},  # feet
